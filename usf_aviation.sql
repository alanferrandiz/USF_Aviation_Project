...
IF OBJECT_ID('planes_maintenances') IS NOT NULL DROP TABLE planes_maintenances;
IF OBJECT_ID('maintenances') IS NOT NULL DROP TABLE maintenances;
IF OBJECT_ID('flights_employees') IS NOT NULL DROP TABLE flights_employees;
...
IF OBJECT_ID('planes') IS NOT NULL DROP TABLE planes;
